...
# Easy-Auto-Research for Deep Learning
...
<p align="center">
  ...
  <a href="https://github.com/wjc2830/Easy-AutoResearch-for-DeepLearning/releases/tag/v1.0.0"><img src="https://img.shields.io/badge/release-v1.0.0-1769ff" alt="Latest release: v1.0.0"></a>
...
```bash
git clone https://github.com/wjc2830/Easy-AutoResearch-for-DeepLearning.git
cd Easy-AutoResearch-for-DeepLearning
```
...
CI runs the suite on Python 3.10, 3.11, and 3.12. It also checks Python compilation, installer syntax, JSON templates, runtime help entry points, and the absence of generated bytecode caches. See [CONTRIBUTING.md](CONTRIBUTING.md) for the contribution and security guidelines.

## Citation

If this software supports your work, cite the repository metadata in [`CITATION.cff`](CITATION.cff). GitHub's **Cite this repository** menu can export it in common citation formats.
